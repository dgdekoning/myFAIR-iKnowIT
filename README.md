...
6. Visit the B2DROP page and create a folder where you can put your datafiles. You can also use the bioinf-galaxian Owncloud if you have an account.
...
12. A cat will appear to let you know that the files are being send to Galaxy.
A checkmark will appear when the files are send to galaxy and the workflow is finished.
...
3. Index the data matrix by clicking on the Upload Files link. Then selecting the folder with the data matrix, then select the matrix file as a datafile and click on the "Make Turtle" button.
4. The metadata will be automatically created and uploaded to the same folder as the data matrix. After this is done you will be redirected to the homepage.
